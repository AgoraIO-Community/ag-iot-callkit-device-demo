...
#define CONFIG_CUSTOMER_KEY "8620f***********************7363"  // Please replace yourself license information
#define CONFIG_CUSTOMER_SECRET "492c1***********************e802" // Please replace yourself license information

#define CONFIG_USER_ID "6875*********3440" // Please replace with your own user ID
#define CONFIG_DEVICE_ID "CALL_DEV_001" // Please replace with your own device ID
...
// Found product key form device manager platform and replace it
...
#define CONFIG_AUDIO_SAMPLE_RATE 8000
